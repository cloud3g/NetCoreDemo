...
layui.use(['upload', 'layer', 'jquery'], function () {
    ...
    var imgName = temp[temp.length - 1].split('.')[0] == "NotPic" ? time : temp[temp.length - 1].split('.')[0];
    //执行实例
    var uploadInst = upload.render({
        ...
        , auto: true
        , data: { isThumbnail: 1, directoryName: "categoryCover", filename: imgName }//接口1代表启用压缩
